    ...
    <div className="max-w-6xl w-full mx-auto mt-10 p-8">
      <div className="flex flex-col md:flex-row gap-8 items-center justify-center bg-gray-50 border-6 border-white rounded-xl px-6 py-10 shadow-xl shadow-gray-200">
        ...
        <div className="max-w-md">
          <h2 className="lg:text-3xl text-xl font-bold lg:mb-4 mb-3 text-gray-800 uppercase text-center lg:text-left">
            Sobre mí
          </h2>

          <div className="h-1 w-full max-w-xs bg-gradient-to-r bg-gray-200 to-gray-100 lg:mb-6 mb-4 lg:mx-0 mx-auto"></div>
          <div className="lg:space-y-4 space-y-3">
            <p className="text-lg text-gray-600 leading-relaxed font-light">
              ...
              orgánico. Su sonido combina texturas suaves, ritmos experimentales
              y una sensibilidad melancólica que mezcla la precisión electrónica
              con un tono íntimo y humano.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed font-light mt-4">
              En su universo, las canciones funcionan como fragmentos de
              memoria: burbujas digitales, plantas que crecen entre glitchs y
              pulsos emocionales que oscilan entre la calma y el caos. Con
              letras que abordan el desapego, la nostalgia y la fugacidad de lo
              cotidiano, del construye paisajes sonoros que se sienten vivos,
              delicados y profundamente personales.
            </p>
          </div>
        </div>
      </div>
